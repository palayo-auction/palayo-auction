...
public enum ErrorCode {
	...
	INVALID_DURATION("경매 종료시간은 시작시간보다 최소 30분 이상 뒤여야 합니다.", HttpStatus.BAD_REQUEST),
	...
	INVALID_DEPOSIT_STATUS("보증금 상태가 이미 변경되었습니다.", HttpStatus.BAD_REQUEST),
	//찜 관련 에러 코드
    ...
    IMAGE_REQUIRED("이미지가 등록되지 않았습니다.", HttpStatus.NOT_FOUND),
    ALREADY_REGISTERED_ITEM("삭제된 아이템은 수정, 삭제가 불가능합니다.",HttpStatus.NOT_FOUND),
    //이미지 관련 에러 코드,
